#ifndef _LINO_WIFIMANAGER__H_
#define _LINO_WIFIMANAGER__H_
...
const int PIN_LED = BUILTIN_LED;  // D4 on NodeMCU and WeMos. GPIO2/ADC12 of ESP32. Controls the onboard LED.
...
bool LINO_WiFi_Conectar() {
    ...
    if (loadConfigData()) {
        ...
        Serial.println(F("Abrindo portal de configuração sem timewout: No stored Credentials."));
        initialConfig = true;
    }
    ...
    if (drd->detectDoubleReset()) {
        ...
        Serial.println(F("Abrindo portal de configuração sem timewout: Double Reset Detected"));
        initialConfig = true;
    }
